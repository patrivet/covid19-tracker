...
function App() {
  ...
  const dataProcessedCount = (countries.length * 2) + 2 // Data processed count represents seperate API calls: countries*3 for -i)Today covid main data ii) yesterday main covid data iii) each country total vaccinations.  + 2 for 2 global data API calls.
  React.useEffect(() => {
